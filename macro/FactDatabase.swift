        ...
        if category == "Art_in_History" && mode == "Comics" && language == "english" {
            return FactData(
                ...
                options: [
                    ...
                    FactOption(title: "Bruno was no ordinary painter... He was part of a mysterious organization called The Brushline.", karma: 10, parts: [
        ...
        if category == "Art_in_History" && mode == "Comics" && language == "arabic" {
            return FactData(
                ...
                options: [
                    ...
                    FactOption(title: "وقف الطفل عند باب برونو وهو يبكي، ولكن من شدة ضحكه الهستيري", karma: 10, parts: [
                        FactPart(sound: "ART IN HISTORY_Horror Mode_OP2 Q1 ARABIC.MP3", text: "الأشخاص الذين يسمعون الصوت ضمن نطاق معين، يبدأون في البكاء دون تفسير", year: "١٨٠٠"),
                        FactPart(sound: "ART IN HISTORY_Horror Mode_OP2 Q2 ARABIC.MP3", text: "كلما اقتربت البشرية من كارثة كبيرة، أصبحت الضحكة في اللوحة أعلى قليلا ... ويبدأ الناس في الشعور بعدم الارتياح في الغرفة", year: "١٩٠٠"),
                        FactPart(sound: "ART IN HISTORY_Horror Mode_OP2 Q3 ARABIC.MP3", text: "المنازل التي تعلق اللوحة لا تحترق، لكن السكان يبدأون في الضحك حتى الموت.", year: "٢٠٠٠")
                    ])
        ...
        if category == "Legends_and_Myths" && mode == "Horror" && language == "english" {
            return FactData(
                ...
                options: [
                    ...
                    FactOption(title: "vlad is born into a peacful aristocratic family", karma: 10, parts: [
...
//6
        if category == "Legends_and_Myths" && mode == "Comics" && language == "english" {
            return FactData(
                ...
                options: [
                    ...
                    FactOption(title: "Vlad chooses to be the Great Protector... through order, not subjugation.", karma: 10, parts: [
            ...
            return FactData(
                ...
                options: [
                    FactOption(title: "أصبح فلاد خادما مخلصا للعثمانيين", karma: -10, parts: [
                        ...
                        FactPart(sound: "LEGENDS & MYTHS_Horror Mode_OP1 Q1 ARABIC.MP3", text: "يستخدم طرق ( التعذيب بالاوتاد ) ضد النبلاء الأوروبيين في الأراضي التي استولى عليها، ويُعرف بلقب ( سلطان الظلال ).", year: "١٤٦٥"),
                    ...
                    FactOption(title: "ولد فلاد في عائلة أرستقراطية مسالمة", karma: 10, parts: [
                     
                        FactPart(sound: "LEGENDS & MYTHS_Horror Mode_OP2 Q1 ARABIC.MP3", text: "تغير مسار تاريخ العثمانيين، مما  أخّر سقوط القسطنطينية وجعل توسعهم أكثر صعوبة.", year: "١٤٥٣"),
                       
                        FactPart(sound: "LEGENDS & MYTHS_Horror Mode_OP2 Q2 ARABIC.MP3", text: "أي شخص يُشتبه في مراسلته مع العثمانيين، أو في امتلاكه ميلاً عاطفيًا يؤدي إلى التمرد، أو في رفضه مبدأ  ( عقلانية فلاد )، كان يُسحب من منزله ليلاً ...  ولا يعود", year: "١٤٦٠"),
        ...
        if category == "Legends_and_Myths" && mode == "Comics" && language == "arabic" {
            return FactData(
                ...
                options: [
                    ...
                    FactOption(title: "يختار فلاد أن يكون ( الحامي الأكبر )... من خلال النظام، لا من خلال الاستعباد.", karma: 10, parts: [
                   
                        FactPart(sound: "LEGENDS & MYTHS_Comics Mode_OP2 Q1 ARABIC.MP3", text: "( ميثاق الدفاع الشعبي ) نظام عدالة 'اجتماعي-عسكري' يجعل الناس شركاء في حكم المملكة والدفاع عنها.", year: "١٤٥٨"),
                     
                        FactPart(sound: "LEGENDS & MYTHS_Comics Mode_OP2 Q2 ARABIC.MP3", text: "( ليالي الوحي ) – كل عام، لمدة ثلاث ليالٍ، يُطلب من الناس كتابة أفكارهم وهمومهم بشكل مجهول، ثم تُقرأ هذه الكتابات بصوت عالٍ.", year: "١٤٦٨"),
                     
                        FactPart(sound: "LEGENDS & MYTHS_Comics Mode_OP2 Q3 ARABIC.MP3", text: "تم إحياء إرث فلاد من خلال منظمة دولية تسمى ( فيجل )، ومقرها داخل قلعة قديمة في ترانسيلفانيا ... وتفتح أبوابها ليلة واحدة فقط كل 10 سنوات.", year: "٢٠٢٥")
                    ])
                ]
            )
        }
        ...
        if category == "Medicine_and_Mind" && mode == "Comics" && language == "english" {
             return FactData(
                 ...
                 options: [
                     ...
                     FactOption(title: "What if cocaine was banned early, and all research was redirected to building tools that strengthened the mind instead of numbing it?.", karma: 10, parts: [
              ...
              return FactData(
                  ...
                  options: [
                      FactOption(title: "ماذا لو لم يُحظر الكوكايين وظل مسكن ألم قانونيًا؟", karma: -10, parts: [
                          ...
                          FactPart(sound: "MEDICINE & MIND_Utopian : Dystopian Mode_OP1 Q1 ARABIC.MP3", text: "اصبح الكوكايين جزءًا أساسيًا في خزانة الأدوية في كل منزل. الأمهات يعطون ( شراب التهدئة ) للأطفال بانتظام دون تساؤل.", year: "١٩٢٠"),
                      ...
                      FactOption(title: "ماذا لو تم حظر الكوكايين... ولكن فقط في العقد ٢٠٠٠؟", karma: -5, parts: [
                          ...
                          FactPart(sound: "MEDICINE & MIND_Utopian : Dystopian Mode_OP2 Q2 ARABIC.MP3", text: "فيديو ينشتر لطفل يهلوس على شراب السعال المخلوط بالكوكايين يثير غضبًا عالميًا.", year: "٢٠٠٣"),
                       
                          FactPart(sound: "MEDICINE & MIND_Utopian : Dystopian Mode_OP2 Q3 ARABIC", text: "تم اقامت أول 'أولمبياد العقل'، ولكن يتم حظرها لاحقًا بسبب سوء استخدامها وآثارها النفسية الخطيرة.", year: "٢٠١٢")
                      ])
                  ]
              )
          }
        ...
        if category == "Medicine_and_Mind" && mode == "Comics" && language == "arabic" {
              return FactData(
                  fact: "في أواخر القرن التاسع عشر، كان الكوكايين يُستخدم على نطاق واسع كمسكن للألم — حتى في الأدوية التي تُصرف دون وصفة طبية ومنتجات التسنين للأطفال. ولم يتم ادراك تأثيراته الإدمانية إلا في أوائل القرن العشرين.",
                  options: [
                      FactOption(title: "ماذا لو استمر استخدام الكوكايين طبيا وتم تطويره لتعزيز العقل البشري؟", karma: -10, parts: [
                        
                          FactPart(sound: "MEDICINE & MIND_Comics Mode_OP1 Q1 ARABIC.MP3", text: "في خضم الحرب العالمية الثانية، اطلقت المختبرات السرية الأوروبية مشروع ( مصل الكوكايين ).  يتم حقن الجنود النخبة بمادة كيميائية تعزز سرعة التفكير وردود الفعل. يصبح البعض أسرع من الصوت — لكن معظمهم يفقدون ذاكرتهم ومشاعرهم مع مرور الوقت.", year: "١٩٤٢"),
                      ...
                      FactOption(title: "ماذا لو تم حظر الكوكايين في وقت مبكر، وتم تحويل جميع الأبحاث نحو بناء أدوات تقوي العقل بدلاً من تخديره؟", karma: 10, parts: [
                     
                          FactPart(sound: "MEDICINE & MIND_Comics Mode_OP2 Q1 ARABIC.MP3", text: "عالم يُدعى لامي غراي اطلق حملة عالمية ضد الكوكايين. تم إغلاق أول مختبر طبي قائم عليه، وتم تحويل التركيز نحو تعزيز العقل دون استخدام المواد.", year: "١٩٠١"),
                ...
                if category == "Human_Rights" && mode == "UtopianDystopian" && language == "english" {
                    return FactData(
                        ...
                        options: [
                            ...
                            FactOption(title: "Queen Victoria issues the Children's Emancipation Act", karma: 10, parts: [
                ...
                if category == "Human_Rights" && mode == "UtopianDystopian" && language == "arabic" {
                    return FactData(
                        ...
                        options: [
                            ...
                            FactOption(title: "سنّ قانون يمنع تشغيل الأطفال في المصانعتصدر الملكة فيكتوريا قانون تحرير الأطفال.", karma: 10, parts: [
